...
public class SHAPES {
	...
	public static final OntClass EnviromentalSensor = M_MODEL.createClass( "http://www.symbiote-h2020.eu/ontology/shapes#EnviromentalSensor" );
	...
	public static final Individual bodyFatPercentage = M_MODEL.createIndividual("http://www.symbiote-h2020.eu/ontology/shapes#bodyFatPercentage", M_MODEL.createClass( "http://www.w3.org/2002/07/owl#NamedIndividual" ) );
	
	public static final Individual bodyMassIndex = M_MODEL.createIndividual("http://www.symbiote-h2020.eu/ontology/shapes#bodyMassIndex", M_MODEL.createClass( "http://www.w3.org/2002/07/owl#NamedIndividual" ) );
	
	public static final Individual bodySkeletalMuscle = M_MODEL.createIndividual("http://www.symbiote-h2020.eu/ontology/shapes#bodySkeletalMuscle", M_MODEL.createClass( "http://www.w3.org/2002/07/owl#NamedIndividual" ) );
	
	public static final Individual bodyWeight = M_MODEL.createIndividual("http://www.symbiote-h2020.eu/ontology/shapes#bodyWeight", M_MODEL.createClass( "http://www.w3.org/2002/07/owl#NamedIndividual" ) );
	
	public static final Individual bodyVisceralFat = M_MODEL.createIndividual("http://www.symbiote-h2020.eu/ontology/shapes#bodyVisceralFat", M_MODEL.createClass( "http://www.w3.org/2002/07/owl#NamedIndividual" ) );
